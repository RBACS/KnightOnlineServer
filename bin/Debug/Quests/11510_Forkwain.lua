...
if (EVENT == 205) then
	SelectMsg(UID, 2, 8, 669, NPC, 10, 193);
	SaveEvent(UID, 442);
end
...
if (EVENT == 6093) then
	...
	elseif (ITEM_COUNT > 0 and ITEM_COUNT1 > 2) then
		SelectMsg(UID, 4, savenum, 6049, NPC, 4006, 7004, 4005, 193);
	end
end
...
if (EVENT == 536) then
	...
	if (ITEM7 > 0) then
		...
		SelectMsg(UID, 2, 9, 4298, NPC, 18, 192);
	end
end 
...
if (EVENT == 1001) then
	SelectMsg(UID, 4, 202, 9239, NPC, 22, 1002, 23, 1003);
end
...
if (EVENT == 1007) then
	...
	if (ITEMBDW < 1) then
		SelectMsg(UID, 2, 202, 9239, NPC, 18, 191);
	else
		SelectMsg(UID, 4, 202, 9239, NPC, 4006, 1008, 4005, 193);
	end
end
